...
class ScrollTest9FragmentAdapter extends FragmentPagerAdapter implements IconPagerAdapter {
    ...
    public ScrollTest9FragmentAdapter(FragmentManager fm, int whichPhoto) {
        super(fm);
